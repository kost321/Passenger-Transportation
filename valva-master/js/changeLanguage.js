let strings = {
    ru: {
        ...
        "title-information":
            "Наша компания предлагает комфортабельные пассажирские и грузовые перевозки по Европе",
        "about-title":
            "ДОБРО ПОЖАЛОВАТЬ НА НАШ САЙТ, СПЕЦИАЛИЗИРУЮЩИЙСЯ НА ПАССАЖИРСКИХ И ГРУЗОВЫХ ПЕРЕВОЗКАХ ПО ЕВРОПЕ!",
        "about-title_information":
            "Мы предлагаем широкий спектр услуг, чтобы удовлетворить любые потребности наших клиентов.",
        ...
        "testimonials": "Отзывы",
        "testimonials-text_firts":
            "Я заказал машину для моей семьи, чтобы добраться до аэропорта. Водитель был очень приятным ипомог нам с нашим багажом. В целом, это было очень приятное и безопасное путешествие.",
        "testimonials-text_second":
            "Я путешествую довольно часто, и могу сказать, что это была одна из лучших поездок. Машина пришлавовремя, водитель был профессиональным и очень доброжелательным.",
        "testimonials-text_third":
            "Очень доволен работой компании. Груз был доставлен вовремя и без повреждений. Операторы связибыли всегда на связи, чтобы дать мне информацию о моем грузе.",
        ...
        "section-contact-info":
            "Свяжитесь с нами сегодня, чтобы получить более подробную информацию о наших услугах и начать сотрудничество!",
        "section-map_title": "Перевозки по странам Европы",
        "section-map_subtitle":
            "Мы предлагаем перевозки грузов во все страны Европы. С нашей помощью вы можете доставить свой груз быстро инадежно.",
        "section-germany": "Германия",
        "section-france": "Франция",
        "section-chesko": "Чехия",
        "section-belgeum": "Бельгия",
        "section-niderlands": "Нидерланды",
        "section-spain": "Испания",
        "section-portugal": "Португалия",
        "section-poland": "Польша",
        "section-austria": "Австрия",
    },
    pl: {
        "welcome": "Główny",
        "about": "O nas",
        ...
        "title-information":
            "Nasza firma oferuje komfortowy przewóz osób i towarów na terenie Europy",
        "about-title":
            "WITAMY NA NASZEJ STRONIE SPECJALIZUJĄCEJ SIĘ W TRANSPORCIE OSOBOWYM I TOWAROWYM W EUROPIE!",
        "about-title_information":
            "Oferujemy szeroki zakres usług, aby zaspokoić wszystkie potrzeby naszych klientów.",
        ...
        "testimonials": "Opinie",
        "testimonials-text_firts":
            "Zarezerwowałem samochód dla mojej rodziny, aby dostać się na lotnisko. Kierowca był bardzo miły i pomógł nam z bagażem. Podsumowując, była to bardzo przyjemna i bezpieczna podróż.",
        "testimonials-text_second":
            "Podróżuję dość często i mogę powiedzieć, że był to jeden z najlepszych wyjazdów. Samochód przyjechał na czas, kierowca był profesjonalny i bardzo przyjazny.",
        "testimonials-text_third":
            "Jestem bardzo zadowolony z pracy firmy. Przesyłka została dostarczona na czas i bez uszkodzeń. Operatorzy telekomunikacyjni byli zawsze w kontakcie, aby udzielić mi informacji o moim ładunku.",
        ...
        "section-contact-info":
            "Skontaktuj się z nami już dziś, aby uzyskać więcej informacji o naszych usługach i rozpocząć współpracę!",
            "section-map_title": "Transport w Europie",
            "section-map_subtitle":"Oferujemy transport ładunków do wszystkich krajów Europy. Z naszą pomocą szybko i sprawnie dostarczysz swój ładunek bezpiecznie.",
            "section-germany": "Niemcy",
            "section-france": "Francja",
            "section-chesko": "Czech",
            "section-belgeum": "Belgia",
            "section-niderlands": "Holandia",
            "section-spain": "Hiszpania",
            "section-portugal": "Portugalia",
            "section-poland": "Polska",
            "section-austria": "Austria",
    },
};
